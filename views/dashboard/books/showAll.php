...
$result = $db->sqlQuery("SELECT books.*,categories.name,languages.lang_name,authors.author_name FROM `books` 
            ...
            <div class="row">
                                ...
                                <?php if ($result && mysqli_num_rows($result) > 0): ?>
                                    ...
                                    while ($book = mysqli_fetch_assoc($result)) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn text-info" href="<?php echo url("update-book&id=" . $book['id']) ?>">
                                                    <i class="fas fa-pen"></i>
                                                </a>
                                                <a class="btn text-danger" href="<?php echo url("delete-book&id=" . $book['id']) ?>">
                ...
                <div class="col-12 my-4">
                    <div class="text-center">
                        <a class="btn btn-primary" href="<?php echo url("add-book") ?>">
                            Add Book
                        </a>
                    </div>
                </div>
